import { getTrainerListBooking } from "api/booking";
...
function PageSchedule() {
    ...
    const { data: bookingData, isLoading, isError } = useQuery("bookingData", () => getTrainerListBooking());
                ...
                </div>
                {
                    isLoading ? (
                        ...
                        <Calendar
                            events={events}
                            eventClick={(arg: any) => {
                                navigate(`/trainer/schedules/${arg.event.id}`);
                            }}
                        />
                    )
                }
